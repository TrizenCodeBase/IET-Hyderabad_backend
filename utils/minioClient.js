...
const minioClient = new S3Client({
    endpoint: process.env.MINIO_ENDPOINT || 'https://lmsbackendminio-api.llp.trizenventures.com',
...
async function testMinioConnection() {
    try {
        ...
        console.log('MinIO Endpoint:', process.env.MINIO_ENDPOINT || 'lmsbackendminio-api.llp.trizenventures.com');
        console.log('Using Access Key:', process.env.MINIO_ACCESS_KEY || 'b72084650d4c21dd04b801f0');
